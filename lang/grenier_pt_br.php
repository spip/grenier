...
// extrait automatiquement de https://trad.spip.net/tradlang_module/grenier?lang_cible=pt_br
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'bouton_radio_sauvegarde_compressee' => 'Cópia de segurança compactadas em @fichier@', # MODIF
	'bouton_radio_sauvegarde_non_compressee' => 'Cópia de segurança não compactada em @fichier@', # MODIF

	// F
	'forum_probleme_database' => 'Problema de base da dados: sua mensagem não foi cadastrada.', # MODIF

	// I
	'ical_lien_rss_breves' => 'Sindicação das notas do site', # MODIF
	'icone_creer_mot_cle_breve' => 'Criar uma nova palavra-chave e associá-la a esta nota', # MODIF
	'icone_forum_administrateur' => 'Fórum dos administradores', # MODIF
	'icone_forum_suivi' => 'Acompanhamento dos fóruns', # MODIF
	'icone_publier_breve' => 'Publicar esta nota', # MODIF
	'icone_refuser_breve' => 'Recusar esta nota', # MODIF
	'info_base_restauration' => 'A base está sendo restaurada.', # MODIF
	'info_breves_03' => 'notas', # MODIF
	'info_breves_liees_mot' => 'As notas associadas a esta palavra-chave', # MODIF
	'info_breves_touvees' => 'Notas encontradas', # MODIF
	'info_breves_touvees_dans_texte' => 'Notas encontradas (no texto)', # MODIF
	'info_echange_message' => 'O SPIP permite a troca de mensagens e a formação de fóruns de discussão privados entre os participantes do site. Você pode ativar ou desativar esta funcionalidade.', # MODIF
	'info_erreur_restauration' => 'Erro de restauração: arquivo inexistente.', # MODIF
	'info_forum_administrateur' => 'fórum dos administradores', # MODIF
	'info_forum_interne' => 'fórum interno', # MODIF
	'info_forum_ouvert' => 'Na área privada do site, há um fórum aberto à participação de todos os redatores cadastrados. Abaixo, você pode ativar um fórum suplementar, reservado apenas aos administradores.', # MODIF
	'info_gauche_suivi_forum' => 'A página de <i>acompanhamento dos fóruns</i> é uma ferramenta de gestão do seu site (e não um espaço de discussão ou de redação). Ela exibe todas as contrubuições do fórum público desta matéria e permite-lhe gerenciar suas contribuições.', # MODIF
	'info_modifier_breve' => 'Editar a nota:', # MODIF
	'info_nombre_breves' => '@nb_breves@ notas,', # MODIF
	'info_option_ne_pas_faire_suivre' => 'Não encaminhar as mensagens dos fóruns', # MODIF
