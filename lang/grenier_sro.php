...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// B
	'bouton_forum_petition' => 'FORUM &amp; PÉTITION', # NEW
	...
	// F
	'forum_probleme_database' => 'Problema nel database. Il tuo messaggio non è stato registrato.', # NEW
	...
	'icone_forum_administrateur' => 'Forum degli amministratori', # NEW
	'icone_forum_suivi' => 'Monitoraggio dei forum', # NEW
	'icone_publier_breve' => 'Publier cette brève', # NEW
	'icone_refuser_breve' => 'Refuser cette brève', # NEW
	'info_base_restauration' => 'La base est en cours de restauration.', # NEW
	'info_breves_03' => 'brèves', # NEW
	'info_breves_liees_mot' => 'Les brèves liées à ce mot-clé', # NEW
	'info_breves_touvees' => 'Brèves trouvées', # NEW
	'info_breves_touvees_dans_texte' => 'Brèves trouvées (dans le texte)', # NEW
	'info_echange_message' => 'SPIP permette lo scambio di messaggi e la costituzione di forum di discussione
privati tra i membri del sito. Puoi attivare o disattivare questa funzionalità.', # NEW
	'info_erreur_restauration' => 'Erreur de restauration : fichier inexistant.', # NEW
	'info_forum_administrateur' => 'forum des administrateurs', # NEW
	'info_forum_interne' => 'forum interne', # NEW
	...
	'info_gauche_suivi_forum' => 'La page de <i>suivi des forums</i> est un outil de gestion de votre site (et non un espace de discussion ou de rédaction). Elle affiche toutes les contributions du forum public de cet article et vous permet de gérer ces contributions.', # NEW
