...
// extrait automatiquement de https://trad.spip.net/tradlang_module/grenier?lang_cible=pt
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'icone_forum_suivi' => 'Seguimento dos fóruns', # MODIF
	'icone_publier_breve' => 'Publicar esta notícia', # MODIF
	'icone_refuser_breve' => 'Recusar esta notícia', # MODIF
	'info_base_restauration' => 'A base está em curso de restauro', # MODIF
	'info_breves_03' => 'notícias', # MODIF
	'info_breves_liees_mot' => 'As notícias ligadas a esta palavra-chave', # MODIF
	'info_breves_touvees' => 'Notícias encontradas', # MODIF
	'info_breves_touvees_dans_texte' => 'Notícias encontradas (no texto)', # MODIF
...
entre os participantes do sítio. Pode activar ou
 desactivar esta funcionalidade.', # MODIF
	'info_erreur_restauration' => 'Erro de restauro : ficheiro inexistente', # MODIF
 ...
 fórum suplementar, reservado apenas aos administradores', # MODIF
	...
	'info_modifier_breve' => 'Modificar a notícia :', # MODIF
	'info_nombre_breves' => '@nb_breves@ notícias,', # MODIF
	'info_option_ne_pas_faire_suivre' => 'Não fazer seguir as mensagens dos fóruns', # MODIF
